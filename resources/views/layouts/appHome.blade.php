            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ url('home\en') }}"><img src="{{asset('images/en.ico')}}"></a>
                            <a class="dropdown-item" href="{{ url('home\es') }}"><img src="{{asset('images/es.ico')}}"></a>
...
<script type="text/javascript" src="{{ asset('js/experts.js') }}"></script>
<script type="text/javascript">
    populateCountries("country", "state","{{$country}}");
    populateStates("country", "state","{{$state}}");
</script>
</html>
